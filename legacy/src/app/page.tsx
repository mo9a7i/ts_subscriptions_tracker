...
// Debug component to show theme state
function ThemeDebug() {
  ...
  useEffect(() => {
    ...
    const updateClass = () => {
      ...
      console.log("ThemeDebug - HTML class:", currentClass)
    }
  ...
  return (
    <div className="fixed top-4 right-4 bg-black text-white p-2 text-xs z-[999]">
      HTML class: {htmlClass || 'none'}
    </div>
  )
}
...
export default function LandingPage() {
  ...
  const screenshots = [
    ...
    },
    {
      ...
      return (
      <div className="min-h-screen bg-red-500 dark:bg-yellow-500">
        <ThemeDebug />
        
        {/* Test different dark mode classes */}
        <div className="p-4 space-y-4">
          <div className="bg-blue-500 dark:bg-green-500 p-4 text-white">
            Test 1: Should be blue in light, green in dark
          </div>
          <div className="bg-white dark:bg-black p-4 text-black dark:text-white">
            Test 2: Should be white in light, black in dark
          </div>
          <div className="text-black dark:text-white">
            Test 3: Text should be black in light, white in dark
          </div>
        </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-neutral-500 dark:text-neutral-400 mb-8 max-w-2xl mx-auto">
            Track, manage, and optimize all your recurring payments in one beautiful dashboard. Never lose track of your
            subscriptions again.
          </p>
              ...
              <Card key={i} className="border-0 shadow-sm">
                <CardContent className="pt-6">
                  ...
                  <p className="text-neutral-500 dark:text-neutral-400 mb-4">
                    "SubTracker has completely changed how I manage my subscriptions. I've saved hundreds of dollars by
                    catching unused services!"
                  </p>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-neutral-500 dark:text-neutral-400 mb-8 max-w-2xl mx-auto">
            Start tracking your subscriptions today. No signup required, your data stays private and secure.
          </p>
          <Link href="/dashboard">
            <Button size="lg" className="text-lg px-8">
              Start Tracking Now
